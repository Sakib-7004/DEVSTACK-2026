...
Dev Stack is a beginner-friendly React website where a user can explore popular development technologies and build a personal technology stack.
The project uses simple React concepts such as components, props, state, useState, useEffect, event handling, conditional rendering, array methods, JSON data fetching, and React Toastify.
...
Props are data passed from a parent component to a child component while state is data managed inside a component that can change while the app is running.
